...
@section('title', 'Tambah PDF Pricelist')

@section('content')
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3>Tambah PDF Pricelist</h3>
            <p class="text-subtitle text-muted">Silahkan upload file PDF yang ingin ditambahkan</p>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input 
                        ...
                        accept=".pdf" 
                        required>
                    <small class="text-muted">Hanya format PDF, max 10MB</small>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    pdfInput.addEventListener("change", function () {
        ...
        info.textContent = `Nama file: ${file.name} (${Math.round(file.size/1024)} KB)`;
